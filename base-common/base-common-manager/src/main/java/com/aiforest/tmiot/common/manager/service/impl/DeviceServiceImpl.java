...
import com.aiforest.tmiot.common.entity.event.MetadataEvent;
import com.aiforest.tmiot.common.enums.MetadataOperateTypeEnum;
import com.aiforest.tmiot.common.enums.MetadataTypeEnum;
import com.aiforest.tmiot.common.exception.*;
import com.aiforest.tmiot.common.manager.biz.ImportDeviceService;
import com.aiforest.tmiot.common.manager.dal.DeviceManager;
import com.aiforest.tmiot.common.manager.entity.bo.*;
import com.aiforest.tmiot.common.manager.entity.builder.DeviceBuilder;
import com.aiforest.tmiot.common.manager.entity.model.DeviceDO;
import com.aiforest.tmiot.common.manager.entity.query.DeviceQuery;
import com.aiforest.tmiot.common.manager.event.metadata.MetadataEventPublisher;
import com.aiforest.tmiot.common.manager.mapper.DeviceMapper;
import com.aiforest.tmiot.common.manager.service.*;
...
import com.aiforest.tmiot.common.utils.PoiUtil;
...
public class DeviceServiceImpl implements DeviceService {
    ...
    @Override
    public Page<DevicePointLatestBO> selectByLatestPage(DeviceQuery entityQuery) {
        if (Objects.isNull(entityQuery.getPage())) {
            entityQuery.setPage(new Pages());
        }
        Page<DeviceDO> entityPageDO = deviceMapper.selectPageWithProfile(PageUtil.page(entityQuery.getPage()), fuzzyQuery(entityQuery), entityQuery.getProfileId());
        Page<DevicePointLatestBO> entityPageBO = deviceBuilder.buildLatestBOPageByDOPage(entityPageDO);

        entityPageBO.getRecords().forEach(device -> device.setPoints(
                pointService.selectByProfileIds(profileBindService.selectProfileIdsByDeviceId(device.getId()))
        ));
    ...
    private Path generateTemplate(Workbook workbook) {
        ...
        try {
            ...
            String fileName = CharSequenceUtil.format("tm_device_import_template_{}.xlsx", System.currentTimeMillis());
