...
import com.aiforest.tmiot.api.center.manager.GrpcRPagePointDTO;
...
public class PointValueServiceImpl implements PointValueService {
    ...
    //TODO modify page to list
    @Override
    public List<PointValueBO> latest(Long deviceId, Long tenantId) {

        PointValueQuery entityQuery = new PointValueQuery();
        entityQuery.setPage(new Pages());

        List<PointValueBO> entityPageBO = new ArrayList<>();
