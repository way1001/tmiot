...
package com.aiforest.tmiot.common.config;

import cn.hutool.core.text.CharSequenceUtil;
import com.aiforest.tmiot.common.constant.common.EnvironmentConstant;
import com.aiforest.tmiot.common.utils.EnvironmentUtil;
...
public class MqttEnvironmentConfig implements EnvironmentPostProcessor {
    ...
    public void postProcessEnvironment(ConfigurableEnvironment environment, SpringApplication application) {
        ...
        if (CharSequenceUtil.isEmpty(node)) {
            prefix = CharSequenceUtil.format("tmiot/{}/{}/", tenant, name);
        }
