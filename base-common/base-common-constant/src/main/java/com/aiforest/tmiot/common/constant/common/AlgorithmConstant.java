...
package com.aiforest.tmiot.common.constant.common;
...
public class AlgorithmConstant {
     ...
     * 默认密钥
     */
    public static final String DEFAULT_KEY = "com.aiforest.tmiot.tm";
    /**
     * 默认密码
     */
    public static final String DEFAULT_PASSWORD = "tm123";
    /**
     * 加密算法 对称AES
     */
