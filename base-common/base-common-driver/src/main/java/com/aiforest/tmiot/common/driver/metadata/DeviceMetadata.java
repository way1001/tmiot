...
package com.aiforest.tmiot.common.driver.metadata;
...
import com.aiforest.tmiot.common.driver.entity.dto.PointAttributeConfigDTO;
import com.aiforest.tmiot.common.driver.entity.dto.PointAttributeDTO;
import com.aiforest.tmiot.common.driver.grpc.client.DeviceClient;
import com.aiforest.tmiot.common.exception.ConfigException;
...
public final class DeviceMetadata {
    ...
    public Map<Long, Map<String, AttributeBO>> getPointConfig(long deviceId) {
        ...
        return pointAttributeConfigMap.entrySet().stream()
                .filter(entry -> MapUtil.isNotEmpty(entry.getValue()) && entry.getValue().keySet().containsAll(attributeMap.keySet()))
