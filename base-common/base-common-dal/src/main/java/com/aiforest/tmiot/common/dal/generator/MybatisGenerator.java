...
package com.aiforest.tmiot.common.dal.generator;
 ...
 * 注意:
 * <p>
 * 当前配置仅用于 base-common-dal 服务模块, 如果需要用于其他模块请重新配置 path 参数。
 *
 * @author way
 * @version 2025.7.0
 * @since 2022.1.0
...
public class MybatisGenerator {
    ...
    public static void generator() {
        String path = System.getProperty("user.dir") + "/base-common/base-common-dal/src/main";
        MybatisUtil.defaultGenerator("base-postgres", "55432", "tm", "tm_auth", "tm", "tm123")
                ...
                .packageConfig(builder -> builder
                        .parent("com.aiforest.tmiot.common.dal")
                        .entity("entity.model")
                        .service("dal")
                        .serviceImpl("dal.impl")
                        .mapper("mapper")
                        .pathInfo(ImmutableMap.of(
                                OutputFile.service, path + "/java/com/aiforest/tmiot/common/dal/dal",
                                OutputFile.serviceImpl, path + "/java/com/aiforest/tmiot/common/dal/dal/impl",
