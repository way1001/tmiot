...
package com.aiforest.tmiot.driver.service.impl;
...
import com.aiforest.tmiot.common.entity.dto.MetadataEventDTO;
...
import com.aiforest.tmiot.driver.service.netty.udp.NettyUdpServer;
...
public class DriverCustomServiceImpl implements DriverCustomService {
    ...
    public RValue read(Map<String, AttributeBO> driverConfig, Map<String, AttributeBO> pointConfig, DeviceBO device, PointBO point) {
         ...
         * 数据接收处理逻辑已在以下类中实现：
         * - {@link com.aiforest.tmiot.driver.service.netty.tcp.NettyTcpServerHandler#channelRead}
         * - {@link com.aiforest.tmiot.driver.service.netty.udp.NettyUdpServerHandler#channelRead0}
         */
        return null;
    }
...
//            channel.writeAndFlush(DecodeUtil.stringToByte(byteData));
